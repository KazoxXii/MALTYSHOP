...
window.MALTY_CONFIG = {
    ...
    formules: [
        { 
            ...
            detail: 'Une seule page conçue pour convertir. Idéal pour les artisans, consultants ou indépendants qui veulent recevoir des appels et devis rapidement. Comprend un formulaire de contact intégré, un bloc témoignages, une section « avant/après » et un appel à l\'action permanent. Parfait pour les campagnes Facebook/Instagram Ads.',
        ...
        { 
            ...
            detail: 'Plusieurs pages pour mette en valeur votre travail. Idéal pour les photographes, architectes, designers, coiffeurs ou toute activité où le visuel fait vendre. Comprend une galerie d\'images animée, des fiches projets, une page « À propos » et un contact stylisé. Le design est cinématique avec des effets de scroll.',
        ...
        { 
            ...
            detail: 'Un site complet multi-pages pour les entreprises qui veulent dominer leur marché local. Comprend une page d\'accueil percutante, une page services, une page à propos, un blog intégré pour le SEO, un formulaire de devis avancé et l\'intégration de vos réseaux sociaux. Parfait pour les artisans, restaurants, cabinets médicaux ou professions libérales.',
        ...
        { 
            ...
            detail: 'Un projet entièrement personnalisé selon votre vision. Idéal pour les entreprises ambitieuses, les startups ou les marques premium qui ont besoin de fonctionnalités spécifiques : réservation en ligne, espace membre, catalogue produit, système de paiement, API sur-mesure. Chaque pixel est pensé pour votre stratégie.',
        ...
        { 
            ...
            detail: 'Une application mobile complète publiée sur l\'App Store et Google Play. Idéal pour les restaurateurs (commande en ligne), les coachs (suivi client), les commerces (programme de fidélité) ou toute activité qui a besoin d\'être dans la poche de ses clients. Comprend notifications push, mode hors-ligne, tableau de bord admin et mises à jour incluses.',
